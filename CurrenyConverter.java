...
public class CurrenyConverter extends javax.swing.JFrame {
   //created a hash map to store rate of currencies 
    ...
    try{
            ...
            if (targetC=="Select currency" || baseC=="Select Currency"){    
                lblrs.setText("Please select a currency!!!");
            }
            else{
                if (targetC=="USD"){
                lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Dollars");
                }
                else if(targetC=="INR"){
                    lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Rupees");
               }
                else if(targetC=="EUR"){
                    lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Euro");  
                }
                else if(targetC=="JPY"){
                    lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Yen");
                }
                else if(targetC=="GBP"){
                    lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Pounds");
                }
                else if(targetC=="AUD"){
                    lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Australian Dollars");
                }
                else{
                    lblrs.setText("Your converted amount is: "+String.format("%.2f", amtB)+" Canadian Dollars");
                } 
            }
